        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <!-- End Navbar Section -->
                       ...
                       <section class="car-header single-search dark-overlay">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 search-section">
                            ...
                            <form >
                                <div class="form-row">
                                    <div class="col-lg-3 col-md-6 col-sm-6 search-col-padding">
                                        <label>Pick Up</label>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 search-col-padding">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="pack-departure-city" class="form-control" required placeholder="E.g. Manikganj">
                                            <div class="input-group-append">
                                                <span class="input-group-text">
                                                    <i class="fa fa-map-marker-alt fa-fw"></i>
                                                </span>
                                    ...
                                    <div class="col-lg-2 col-md-3 col-sm-3 search-col-padding">
                                    ...
                                    <div class="col-lg-1 col-md-3 col-sm-3 col-6 search-col-padding">
                                        <label>Adults</label>
                                    ...
                                    <div class="col-md-12 text-center search-col-padding">
                                        <button type="submit" class="btn btn-theme md-btn text-uppercase">Search Car</button>
                                    </div>
                                </div>
                            </form>
                            <!-- End Car Search -->
