<?php
$Send='';
$error='Welcome to Vromon Bilash !';
$user_id='';
if(isset($_POST['Submit'])){
    if(empty($_POST['email'])|| empty($_POST['password'])){
      $error="Your Email or Password";
    ...
    include('Config.php');
      ...
      $sql = " SELECT * FROM g_user where password='".mysqli_real_escape_string($db,$password)."' and  email='".mysqli_real_escape_string($db,$email)."' and valid='0' ";
      $sql1 = " SELECT * FROM g_user where password='".mysqli_real_escape_string($db,$password)."' and  email='".mysqli_real_escape_string($db,$email)."' and valid='1' ";
      ...
      if($result->num_rows > 0)
      {
        ...
        session_start();
        $_SESSION['g_user_id']=$data['g_user_id'];
                            ...
                            <div class="navbar navbar-default navbar-expand-lg navbar-light" role="navigation">
                                ...
                                <div class="navbar-collapse collapse">
                                    <ul class="navbar-nav navbar-right ml-auto">
                                        ...
                                        <li class="dropdown mega nav-item">
                                            <a class="toggle nav-link" href="#" data-toggle="dropdown">HIRE-A-CAR</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="form-group">
                                                    <button class="btn btn-theme btn-block md-btn text-uppercase" name="Submit" type="submit">Log-In</button>
                                                </div>

                                            </form>
                                            <!-- End Form for Login  -->
                                            <div class="form-group">
                                                <label class="form-text text-muted">Don't have an account?</label>
                                                <a class="btn btn-theme md-btn btn-block text-uppercase" href="register-g.php">Sign-up</a>
                                            </div>
